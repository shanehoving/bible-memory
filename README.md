...
This app is a companion to [Truth Declarations](https://github.com/shanehoving/truth-declarations), a randomized scripture declaration generator built in the same visual style.